    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`w-full flex items-center gap-2.5 px-4 py-3 border-t border-sonos-border/40 transition-colors ${isSettings ? 'text-sonos-accent' : 'text-sonos-muted/40 hover:text-sonos-muted'}`}
        >
